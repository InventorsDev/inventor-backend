...
import { Registration, RegistrationSchema } from 'src/shared/schema/lead_registration.schema';
import { UsersModule } from '../users/users.module'; // Import the UsersModule
import { User, UserSchema } from 'src/shared/schema';
import { TempLeadRegistration, TempLeadRegistrationSchema } from 'src/shared/schema/temp_lead_registration.schema';
